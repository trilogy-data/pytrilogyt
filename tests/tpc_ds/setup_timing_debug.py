## Uncomment this script as a starting point for debugging the TPC_ds setup timing
...
#     print(f"Wiped output directory {datetime.now() - start}")

#     optimizer.optimizations_to_files(optimizations, root, output_path)

#     print(f"Optimizations written to files {datetime.now() - start}")
