...
def run_query(engine: Executor, idx: int, optimized_path, profile: bool = False):
...
def test_sixteen(engine, optimized_env):
    run_query(engine, 16, optimized_env)


def test_twenty_one(engine, optimized_env):
    run_query(engine, 21, optimized_env)


def test_twenty_four(engine, optimized_env):
    run_query(engine, 24, optimized_env)


def test_twenty_five(engine, optimized_env):
    run_query(engine, 25, optimized_env)


def test_twenty_six(engine, optimized_env):
    run_query(engine, 26, optimized_env)


def test_thirty(engine, optimized_env):
    run_query(engine, 30, optimized_env)


def test_thirty_two(engine, optimized_env):
    run_query(engine, 32, optimized_env)


def test_ninety_five(engine, optimized_env):
    run_query(engine, 95, optimized_env)


def test_ninety_seven(engine, optimized_env):
    run_query(engine, 97, optimized_env)


def test_ninety_eight(engine, optimized_env):
    run_query(engine, 98, optimized_env)


def test_ninety_nine(engine, optimized_env):
    run_query(engine, 99, optimized_env)
